...
issue](https://github.com/cisagov/con-pca-tasks/issues) in this
...
request](https://github.com/cisagov/con-pca-tasks/pulls), you will
...
```console
cd con-pca-tasks
pyenv virtualenv <python_version_to_use> con-pca-tasks
pyenv local con-pca-tasks
